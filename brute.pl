...
rikudo(Size,Pre,Links,Res):-S is Size-1,createPuzzle(Size,OutNum,OutPairs),createListPre(Pre,Pair,Num),
							...
							assign_digits(PairList,NumList,Assigned),concat(Assigned,Pre,Res),
							checkCons(S,Res,Res).

/* [(2,4,59),(-1,3,56),(1,3,60),(-6,2,1),(4,2,42),(-1,1,20),(2,0,26),(6,0,38),(-5,-1,6),(-2,-2,17),(4,-2,34),(-5,-3,9)]    */

/*
[(-3,3,32),(3,3,12),(2,2,15),(-1,1,28),(5,1,10),(2,0,17),(1,-1,19),(-5,-1,36),(5,-1,6),(0,-2,1),(-3,-3,23)]
[(3,1,2,2),(-1,-1,-2,-2),(-2,-2,-1,-3),(1,-3,3,-3),(3,-3,4,-2)]
*/
